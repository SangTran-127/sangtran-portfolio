                ...
                <div className='flex items-center'>
                    <Link href={post.author?.profileUrl || '#'}>
                        <div className='flex items-center gap-2'>
                            <Image className='inline-block rounded-full ring-2 ring-white' src={post.author?.avatarUrl || ''} alt={post.author?.name || ' '} width={20} height={20} />
                            <p className='text-dracula-purple text-sm'>{post.author?.name}</p>
                        </div>
                    </Link>
                    <p className=''> - </p>
                    <p className='text-dracula-light text-sm'>
